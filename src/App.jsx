  ...
  return (
    <div>
      ...
      <Card style={{position:"relative"}}>
        ...
        }, `📜 Neste dia na história — ${vDay} de ${MONTHS[vMonth]}:\n\n${historia}`)} style={{background:"rgba(0,0,0,0.05)"}}/>
        <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:8}}>
          📜 História do Dia
        </div>
        <div style={{fontSize:12,color:"#9CA3AF",marginBottom:12}}>{vDay} de {MONTHS[vMonth]}</div>
