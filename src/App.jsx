...
const QUIZ_BANKS = {
  cinema: {
    emoji: "🎬", nome: "Cinema & Séries", cor: "#8B5CF6", desc: "Telas grandes e pequenas",
    niveis: {
      facil: [
  ...
  musica: {
    emoji: "🎵", nome: "Música", cor: "#EC4899", desc: "Do clássico ao pop",
    niveis: {
      facil: [
  ...
  mundo: {
    emoji: "🌍", nome: "Conhecimentos Gerais", cor: "#3B82F6", desc: "Geografia, história e ciência",
    niveis: {
      facil: [
  ...
  brasil: {
    emoji: "🇧🇷", nome: "Quiz Brasil", cor: "#10B981", desc: "Cultura, história e futebol",
    niveis: {
      facil: [
  ...
  logica: {
    emoji: "🧩", nome: "Lógica & Charadas", cor: "#F59E0B", desc: "Raciocínio e quebra-cabeças",
    niveis: {
      facil: [
  ...
  capitais: {
    emoji: "🏛️", nome: "Capitais do Mundo", cor: "#06B6D4", desc: "Geografia na ponta da língua",
    niveis: {
      facil: [
  ...
  matematica: {
    emoji: "➗", nome: "Matemática Divertida", cor: "#6366F1", desc: "Exercite o raciocínio",
    niveis: {
      facil: [
  ...
  proverbios: {
    emoji: "💬", nome: "Provérbios e Ditados", cor: "#F97316", desc: "Sabedoria popular",
    niveis: {
      facil: [
  ...
  curiosidades: {
    emoji: "🤯", nome: "Curiosidades Insanas", cor: "#A855F7", desc: "Fatos que parecem mentira",
    niveis: {
      facil: [
  ...
  qi: {
    emoji: "🧠", nome: "QI Cultural", cor: "#F59E0B", desc: "Cultura geral e conhecimento",
    niveis: {
      facil: [
        { q: "Quem pintou a Mona Lisa?", opts: ["Michelangelo","Leonardo da Vinci","Rafael","Caravaggio"], c: 1 },
        { q: "Em que ano o homem pisou na Lua?", opts: ["1965","1967","1969","1971"], c: 2 },
  ...
  mitologia: {
    emoji:"🏛️", nome:"Mitologia dos Signos", cor:"#7C3AED", desc:"Histórias por trás das constelações",
  ...
  elementos: {
    emoji:"🔥", nome:"Signos e Elementos", cor:"#DC2626", desc:"Os 4 elementos e o zodíaco",
    ...
    <div>
      ...
      {isToday && profile?.name && (
        <Card style={{background:"linear-gradient(135deg,#0A1F1A,#1a3a2a)",color:"#fff",marginBottom:14}}>
          <div style={{fontSize:15,fontWeight:800,marginBottom:4}}>{saudacao}, {nomeUser}! 👋</div>
      ...
      <div style={{marginBottom:14}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
          <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1}}>🌍 Hoje no Mundo</div>
        ...
        <Card style={{background:"linear-gradient(135deg,#0A1F1A,#1a3a2a)",color:"#fff",marginBottom:0,padding:"14px 16px"}}>
          {calendarios.map((cal,idx)=>(
            <div key={cal.nome} style={{display:"flex",alignItems:"center",gap:14,padding:"10px 0",borderBottom:idx<calendarios.length-1?"1px solid rgba(255,255,255,0.08)":"none"}}>
              <div style={{fontSize:28,flexShrink:0,width:36,textAlign:"center"}}>{cal.emoji}</div>
              <div style={{flex:1}}>
                <div style={{fontSize:10,color:"#34D399",fontWeight:700,textTransform:"uppercase",letterSpacing:0.8,marginBottom:1}}>{cal.nome}</div>
                <div style={{fontSize:14,fontWeight:700,color:"#fff"}}>{cal.formatado}</div>
              </div>
            </div>
          ))}
        </Card>
      ...
      <Card style={{position:"relative",marginBottom:14}}>
        ...
        {historia?.licao && <div style={{fontSize:13,color:"#065F46",lineHeight:1.55,marginTop:12,padding:"10px 14px",background:"#F0FDF4",borderRadius:10,borderLeft:"3px solid #10B981"}}>💡 {historia.licao}</div>}
      </Card>

      {/* #5 Efeméride interativa */}
      <Card style={{marginBottom:14}}>
        ...
        {efem.map((ev,i)=>(
          <div key={i} style={{display:"flex",gap:10,alignItems:"center",padding:"7px 0",borderBottom:i<2?"1px solid #F3F4F6":"none"}}>
            ...
            <div style={{flex:1}}>
              <div style={{fontSize:12,fontWeight:700,color:"#0A1F1A"}}>{ev.t}</div>
              <div style={{fontSize:10,color:"#9CA3AF"}}>{ev.a}</div>
            </div>
          </div>
        ))}
      </Card>

      {/* #26 Famoso do Dia interativo + #39 Curiosidade */}
      <Card style={{marginBottom:14}}>
        ...
        <div style={{display:"flex",gap:14,alignItems:"flex-start"}}>
          ...
          <div style={{flex:1}}>
            ...
            {famous.quote && <div style={{fontSize:13,color:"#374151",lineHeight:1.6,fontStyle:"italic",marginTop:10,borderLeft:"3px solid #10B981",paddingLeft:12}}>"{famous.quote}"</div>}
            {famous.fact && <div style={{fontSize:12,color:"#6B7280",marginTop:8,lineHeight:1.6}}>{famous.fact}</div>}
            {famous.curiosity && <div style={{fontSize:11,color:"#374151",marginTop:8,lineHeight:1.5,background:"#F9FAFB",borderRadius:8,padding:"7px 10px"}}>✨ {famous.curiosity}</div>}
            <button onClick={goCoincidence} style={{marginTop:10,background:"#0A1F1A",color:"#10B981",border:"none",borderRadius:20,padding:"7px 14px",fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>
              Ver minhas coincidências com {famous.name.split(" ")[0]} →
            </button>
          </div>
        </div>
      </Card>

      {/* #3 Palavra intraduzível */}
      <Card style={{marginBottom:14}}>
        <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10}}>🔤 Palavra Intraduzível do Dia</div>
        <div style={{display:"flex",gap:12,alignItems:"flex-start"}}>
          <div style={{width:44,height:44,borderRadius:12,background:"#F3F4F6",display:"flex",alignItems:"center",justifyContent:"center",fontSize:24,flexShrink:0}}>{palavra.e}</div>
          <div style={{flex:1}}>
            <div style={{fontSize:18,fontWeight:900,color:"#0A1F1A"}}>{palavra.p}</div>
            <div style={{fontSize:10,color:"#10B981",fontWeight:700,marginBottom:4,textTransform:"uppercase",letterSpacing:.5}}>{palavra.l}</div>
            <div style={{fontSize:13,color:"#6B7280",lineHeight:1.6}}>{palavra.d}</div>
          </div>
        </div>
      </Card>
      ...
      {/* #9 Invenção do dia */}
      <Card style={{marginBottom:14}}>
        <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10}}>⚙️ Invenção do Dia</div>
        <div style={{display:"flex",gap:12,alignItems:"center"}}>
          <div style={{width:44,height:44,borderRadius:12,background:"#F3F4F6",display:"flex",alignItems:"center",justifyContent:"center",fontSize:24,flexShrink:0}}>{invencao.e}</div>
          <div style={{flex:1}}>
            <div style={{fontSize:15,fontWeight:800,color:"#0A1F1A"}}>{invencao.i} <span style={{fontSize:11,color:"#9CA3AF",fontWeight:500}}>({invencao.a})</span></div>
            <div style={{fontSize:12,color:"#6B7280",marginTop:4,lineHeight:1.5}}>{invencao.q}</div>
          </div>
        </div>
      </Card>

      {/* #11 Hoje no espaço — dark, on-brand */}
      <Card style={{background:"linear-gradient(135deg,#0A1F1A,#1a3a2a)",color:"#fff",marginBottom:14}}>
        <div style={{fontSize:11,color:"#34D399",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:8}}>🔭 Hoje no Espaço</div>
        <div style={{display:"flex",gap:12,alignItems:"center"}}>
          <div style={{width:44,height:44,borderRadius:12,background:"#ffffff10",display:"flex",alignItems:"center",justifyContent:"center",fontSize:24,flexShrink:0}}>{espaco.e}</div>
          <div style={{flex:1}}>
            <div style={{fontSize:15,fontWeight:800,color:"#fff"}}>{espaco.t}</div>
            <div style={{fontSize:12,color:"#A7F3D0",marginTop:4,lineHeight:1.5}}>{espaco.d}</div>
          </div>
        </div>
      </Card>

      {/* #18 Descoberta científica */}
      <Card style={{marginBottom:14}}>
        <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10}}>🔬 Descoberta Científica do Dia</div>
        <div style={{display:"flex",gap:12,alignItems:"flex-start"}}>
          <div style={{width:44,height:44,borderRadius:12,background:"#F3F4F6",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0}}>{descoberta.e}</div>
          <div style={{flex:1}}>
            <div style={{fontSize:15,fontWeight:800,color:"#0A1F1A"}}>{descoberta.d}</div>
            <div style={{fontSize:11,color:"#9CA3AF",marginBottom:4}}>{descoberta.c} · {descoberta.a}</div>
            <div style={{fontSize:12,color:"#6B7280",lineHeight:1.5}}>{descoberta.f}</div>
          </div>
        </div>
      </Card>
      ...
      {/* #13 Lugar do dia */}
      <Card style={{marginBottom:14}}>
        <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10}}>🗺️ Lugar do Dia</div>
        <div style={{display:"flex",gap:12,alignItems:"flex-start"}}>
          <div style={{width:44,height:44,borderRadius:12,background:"#F3F4F6",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0}}>{lugar.e}</div>
          <div style={{flex:1}}>
            <div style={{fontSize:15,fontWeight:800,color:"#0A1F1A"}}>{lugar.l}</div>
            <div style={{fontSize:12,color:"#6B7280",marginTop:4,lineHeight:1.5}}>{lugar.f}</div>
          </div>
        </div>
      </Card>
      ...
      {/* #16 Música do dia */}
      <Card style={{marginBottom:14}}>
        <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10}}>🎵 Música do Dia</div>
        <div style={{display:"flex",gap:12,alignItems:"flex-start"}}>
          <div style={{width:44,height:44,borderRadius:12,background:"#F3F4F6",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0}}>{musica.e}</div>
          <div style={{flex:1}}>
            <div style={{fontSize:15,fontWeight:800,color:"#0A1F1A"}}>{musica.m}</div>
            <div style={{fontSize:11,color:"#9CA3AF",marginBottom:4}}>{musica.a} · {musica.y}</div>
            <div style={{fontSize:12,color:"#6B7280",lineHeight:1.5}}>{musica.f}</div>
          </div>
        </div>
      </Card>
      ...
      {/* #15 Hábito do dia */}
      <Card style={{marginBottom:14,borderLeft:"3px solid #10B981"}}>
        <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10}}>💪 Hábito do Dia</div>
        <div style={{display:"flex",gap:12,alignItems:"flex-start"}}>
          ...
          <div style={{flex:1}}>
            <div style={{fontSize:15,fontWeight:800,color:"#0A1F1A"}}>{habito.h}</div>
            <div style={{fontSize:12,color:"#6B7280",marginTop:4,lineHeight:1.5}}>{habito.i}</div>
          </div>
        </div>
      </Card>
      ...
      {/* #25 Charada do dia */}
      <Card style={{marginBottom:14}}>
        <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10}}>🧩 Charada do Dia</div>
        <div style={{fontSize:14,fontWeight:600,color:"#0A1F1A",lineHeight:1.6,marginBottom:12}}>{charada.p}</div>
        {charadaReveal
          ? <div style={{background:"#F0FDF4",borderRadius:10,padding:"8px 12px",fontSize:13,color:"#065F46",fontWeight:700,borderLeft:"3px solid #10B981"}}>✅ {charada.r}</div>
          : <button onClick={()=>setCharadaReveal(true)} style={{background:"#0A1F1A",color:"#10B981",border:"none",borderRadius:20,padding:"7px 16px",fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>Revelar resposta</button>
        }
      </Card>
      ...
      {diaPessoal && (
        <Card style={{marginBottom:14}}>
          <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10}}>🔢 Seu Dia Pessoal</div>
          <div style={{display:"flex",gap:12,alignItems:"center"}}>
            <div style={{width:52,height:52,borderRadius:14,background:"#0A1F1A",display:"flex",alignItems:"center",justifyContent:"center",fontSize:24,fontWeight:900,color:"#10B981",flexShrink:0}}>{diaPessoal.n}</div>
            <div style={{flex:1}}>
              <div style={{fontSize:15,fontWeight:800,color:"#0A1F1A"}}>{diaPessoal.sig}</div>
              <div style={{fontSize:11,color:"#9CA3AF",marginTop:3}}>Número {diaPessoal.n} · Baseado no seu nascimento</div>
            </div>
          </div>
        </Card>
      )}

      {/* #54 Lembrete — semCoinc calculado acima */}
      ...
      <Card style={{marginBottom:14}}>
        ...
        <div style={{fontSize:15,color:"#0A1F1A",lineHeight:1.8,fontWeight:500,fontStyle:"italic",borderLeft:"3px solid #10B981",paddingLeft:14}}>"{mensagemDia}"</div>
      </Card>
      ...
      <Card style={{marginBottom:14}}>
        ...
        <div style={{display:"flex",gap:12,alignItems:"flex-start"}}>
          <div style={{width:38,height:38,borderRadius:10,background:"#F3F4F6",display:"flex",alignItems:"center",justifyContent:"center",fontSize:20,flexShrink:0}}>{proverbio.e}</div>
          <div style={{flex:1}}>
            <div style={{fontSize:14,fontWeight:600,color:"#0A1F1A",lineHeight:1.6,fontStyle:"italic",marginBottom:6}}>"{proverbio.p}"</div>
            <div style={{fontSize:11,color:"#9CA3AF",fontWeight:600}}>— {proverbio.t}</div>
          </div>
        </div>
      </Card>
      ...
      {/* #57 Sugestão do dia */}
      {isToday && sugestao && (
        <Card onClick={()=>{ if(sugestao.tab==="quizzes"&&goQuizzes) goQuizzes(); else if(sugestao.tab==="komparai") goCoincidence(); else if(goTest) goTest(); }} style={{cursor:"pointer",marginBottom:14,borderLeft:"3px solid #10B981"}}>
          <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:6}}>💡 Sugestão do Dia</div>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            <div style={{fontSize:14,fontWeight:700,color:"#0A1F1A"}}>{sugestao.t}</div>
            <span style={{fontSize:16,color:"#10B981",fontWeight:700}}>→</span>
          </div>
        </Card>
      )}

      {/* #54 Lembrete inteligente */}
      {isToday && semCoinc && (
        <div style={{background:"#F9FAFB",borderRadius:14,padding:"12px 14px",marginBottom:14,display:"flex",gap:10,alignItems:"center",border:"1px solid #E5E7EB"}}>
          <span style={{fontSize:20}}>🔔</span>
          <div style={{flex:1}}>
            <div style={{fontSize:12,fontWeight:700,color:"#0A1F1A"}}>Ainda não descobriu suas coincidências!</div>
            <div style={{fontSize:11,color:"#6B7280",marginTop:2}}>Veja com qual famoso você mais combina.</div>
          </div>
          <button onClick={goCoincidence} style={{background:"#0A1F1A",color:"#10B981",border:"none",borderRadius:20,padding:"6px 14px",fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"inherit",whiteSpace:"nowrap"}}>Ver →</button>
        </div>
      )}
    </div>
  );
        ...
        return (
          <div>
            ...
            <div style={{textAlign:"center",fontSize:12,color:"#6B7280",fontWeight:600,marginTop:10}}>
              365 famosos · 7 tipos de conexão
            </div>
          </div>
        );
      })()}
      ...
      {famosoTop && total > 0 && (
        <div style={{
          ...
          <div style={{position:"relative",zIndex:2}}>
            ...
            {/* ── #87 Comparação lado a lado ── */}
            {(() => {
              const uSign = profile?.birthDay && profile?.birthMonth ? getSign(parseInt(profile.birthDay), parseInt(profile.birthMonth)) : null;
              const cSign = getSign(famosoTop.cel.day, famosoTop.cel.month);
              const getGen = y => !y?"—":y<1946?"Silenciosa":y<1965?"Baby Boomer":y<1980?"Geração X":y<1997?"Millennial":y<2013?"Geração Z":"Alpha";
              const rows = [
                { icon:"🎂", você:`${profile?.birthDay||"?"}/${profile?.birthMonth||"?"}/${profile?.birthYear||"?"}`, famoso:`${famosoTop.cel.day}/${famosoTop.cel.month}/${famosoTop.cel.born}` },
                { icon:"📏", você:profile?.height?`${profile.height}cm`:"—", famoso:`${famosoTop.cel.height}cm` },
                { icon:"⚖️", você:profile?.weight?`${profile.weight}kg`:"—", famoso:`${famosoTop.cel.weight}kg` },
                { icon:uSign?SIGN_EMOJI[uSign]:"✨", você:uSign||"—", famoso:cSign },
                { icon:"🎉", você:getGen(profile?.birthYear), famoso:getGen(famosoTop.cel.born) },
              ];
              return (
                <div style={{marginTop:12,background:"#ffffff08",borderRadius:12,overflow:"hidden"}}>
                  <div style={{display:"grid",gridTemplateColumns:"22px 1fr 1fr",padding:"7px 10px 4px",gap:4}}>
                    ...
                    <div style={{fontSize:9,color:"#A7F3D0",fontWeight:800,letterSpacing:1,textTransform:"uppercase"}}>{famosoTop.cel.name.split(" ")[0].toUpperCase()}</div>
                  </div>
                  {rows.map((r,i)=>(
                    <div key={i} style={{display:"grid",gridTemplateColumns:"22px 1fr 1fr",padding:"5px 10px",gap:4,background:i%2===0?"#ffffff06":"transparent",alignItems:"center"}}>
...
function AstralScreen({profile, goHumor, goTest, goQuizzes}) {
  ...
  return (
    <div>
      ...
      {/* #1 Horóscopo diário personalizado */}
      {sign && horoscDia && (
        <Card style={{marginBottom:14,borderLeft:"3px solid #7C3AED"}}>
          <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:8}}>{SIGN_EMOJI[sign]} Horóscopo de Hoje · {sign}</div>
          <div style={{fontSize:15,color:"#0A1F1A",lineHeight:1.7,fontWeight:500}}>{horoscDia}</div>
        </Card>
      )}
      {!sign && (
      ...
      {/* #2 Energia do dia por área */}
      <Card style={{marginBottom:14}}>
        <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:12}}>⚡ Energia do Dia</div>
      ...
      <Card style={{marginBottom:14,borderLeft:`3px solid ${elem.cor}`}}>
        ...
        <div style={{display:"flex",gap:12,alignItems:"center"}}>
          <div style={{width:44,height:44,borderRadius:12,background:`${elem.cor}15`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:26,flexShrink:0}}>{elem.emoji}</div>
          <div style={{flex:1}}>
            ...
            <div style={{fontSize:10,color:elem.cor,fontWeight:600,marginTop:4}}>{elem.signos}</div>
          </div>
        </div>
        <div style={{marginTop:8,fontSize:12,color:elem.cor,fontStyle:"italic",fontWeight:600}}>💡 {elem.dica}</div>
      </Card>
      ...
      {afirm && (
        <Card style={{marginBottom:14}}>
          ...
          <div style={{fontSize:15,color:"#0A1F1A",lineHeight:1.7,fontStyle:"italic",borderLeft:"3px solid #10B981",paddingLeft:12}}>"{afirm}"</div>
        </Card>
      )}
      ...
      {numInfo && (
        <Card style={{background:"linear-gradient(135deg,#0A1F1A,#1a3a2a)",marginBottom:14,position:"relative",overflow:"hidden"}}>
          <ShareBtn onClick={()=>shareContent("numerologia",{nome:profile?.name||"",numero:String(numInfo.numero),arquetipo:numInfo.nome,essencia:numInfo.essencia},`🔢 Minha numerologia:\n\nNúmero ${numInfo.numero} — ${numInfo.nome}\n${numInfo.arquetipo}\n\n"${numInfo.essencia}"`)} style={{background:"rgba(255,255,255,0.95)"}}/>
          ...
          <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:10,position:"relative"}}>
            ...
            <div>
              <div style={{fontSize:10,color:"#34D399",fontWeight:700,textTransform:"uppercase",letterSpacing:1.5,marginBottom:2}}>🔢 Numerologia</div>
          ...
          <div style={{fontSize:13,color:"#D1FAE5",lineHeight:1.6,marginBottom:8,fontStyle:"italic",borderLeft:"3px solid #10B981",paddingLeft:12}}>"{numInfo.essencia}"</div>
      ...
      {sistema==="ocidental" && sign && (
        <Card style={{background:"linear-gradient(135deg,#7C3AED18,#7C3AED06)",border:"1px solid #7C3AED30",position:"relative",marginBottom:14}}>
          <ShareBtn onClick={()=>shareContent("horoscopo",{nome:profile?.name||"",signo:sign,emoji:SIGN_EMOJI[sign],sistema:"Astrologia Ocidental",mensagem:horoscDia||""},`♈ Meu signo é ${sign}\n\n${horoscDia||""}`)}/>
          ...
          <div style={{fontSize:14,color:"#374151",lineHeight:1.7}}>{horoscDia||"Sua energia astral está em harmonia com os movimentos celestes de hoje. Confie na sua intuição."}</div>
        </Card>
      )}
      ...
      {sistema==="chines" && animal && ANIMAIS_CHINESES[animal] && (
        <Card style={{background:"linear-gradient(135deg,#DC262618,#DC262606)",border:"1px solid #DC262630",position:"relative",marginBottom:14}}>
          ...
          <div style={{marginTop:10,padding:"10px 12px",background:"#FEF2F2",borderRadius:10,borderLeft:"3px solid #DC2626"}}>
      ...
      {sistema==="vedico" && rashi && RASHIS_VEDICOS[rashi] && (
        <Card style={{background:"linear-gradient(135deg,#F59E0B18,#F59E0B06)",border:"1px solid #F59E0B30",position:"relative",marginBottom:14}}>
      ...
      {sistema==="judaico" && (
        <Card style={{background:"linear-gradient(135deg,#7C3AED18,#7C3AED06)",border:"1px solid #7C3AED30",marginBottom:14}}>
      ...
      {/* #11 Fase da lua — visual expandido */}
      {(() => {
        const lua = getFaseLua();
        const pct = lua.iluminacao;
        return (
          <Card style={{background:"linear-gradient(135deg,#0A1F1A,#1a3a2a)",marginBottom:14}}>
            <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:10}}>
              <span style={{fontSize:44}}>{lua.emoji}</span>
              <div style={{flex:1}}>
                <div style={{fontSize:10,color:"#34D399",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:2}}>🌙 Lua de Hoje</div>
                <div style={{fontSize:18,fontWeight:900,color:"#fff"}}>{lua.fase}</div>
                <div style={{fontSize:11,color:"#6EE7B7"}}>{lua.nomeEspiritual}</div>
              </div>
            </div>
            {/* barra visual de iluminação */}
            <div style={{marginBottom:10}}>
              <div style={{display:"flex",justifyContent:"space-between",fontSize:10,color:"#6EE7B7",marginBottom:4}}>
                <span>🌑 Nova</span><span>{pct}% iluminada</span><span>🌕 Cheia</span>
              </div>
              <div style={{height:6,background:"#ffffff20",borderRadius:4,overflow:"hidden"}}>
                <div style={{height:"100%",width:`${pct}%`,background:"linear-gradient(90deg,#10B981,#6EE7B7)",borderRadius:4}}/>
              </div>
            </div>
            <div style={{fontSize:13,color:"#D1FAE5",lineHeight:1.6,marginBottom:8}}>{lua.desc}</div>
            <div style={{background:"#10B98120",borderRadius:10,padding:"10px 12px",marginBottom:8}}>
              <div style={{fontSize:10,color:"#34D399",fontWeight:700,marginBottom:3}}>🌿 RITUAL DO DIA</div>
              <div style={{fontSize:13,color:"#A7F3D0"}}>{lua.ritual}</div>
            </div>
            <div style={{fontSize:12,color:"#6EE7B7",fontStyle:"italic"}}>"{lua.afirmacao}"</div>
            <div style={{marginTop:8,fontSize:11,color:"#9CA3AF"}}>Dia {lua.diaDoCliclo} do ciclo · Próxima Lua Nova em {lua.proximaLuaNova} dias</div>
          </Card>
        );
      })()}
      ...
      {/* #17 Próxima Superlua */}
      {proxSuperlua && (
        <Card style={{marginBottom:14,borderLeft:"3px solid #F59E0B"}}>
          <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:8}}>🌕 Próxima Superlua</div>
          <div style={{display:"flex",gap:12,alignItems:"center"}}>
            <div style={{width:52,height:52,borderRadius:14,background:"#0A1F1A",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
              <div style={{textAlign:"center"}}>
                <div style={{fontSize:18,fontWeight:900,color:"#F59E0B",lineHeight:1}}>{proxSuperlua.dias}</div>
                <div style={{fontSize:8,color:"#6EE7B7",fontWeight:600}}>DIAS</div>
              </div>
            </div>
            <div style={{flex:1}}>
              <div style={{fontSize:14,fontWeight:800,color:"#0A1F1A"}}>{proxSuperlua.nome}</div>
              <div style={{fontSize:11,color:"#9CA3AF",marginTop:2}}>{proxSuperlua.dataFmt}</div>
              <div style={{fontSize:12,color:"#6B7280",marginTop:4,lineHeight:1.5}}>{proxSuperlua.desc}</div>
            </div>
          </div>
        </Card>
      )}
      ...
      {/* #18 Tarot do dia */}
      <Card style={{marginBottom:14}}>
        <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10}}>🃏 Tarot do Dia · Arcano {tarot.n}</div>
        <div style={{display:"flex",gap:14,alignItems:"center",marginBottom:10}}>
          <div style={{width:54,height:54,borderRadius:14,background:"linear-gradient(135deg,#0A1F1A,#1a3a2a)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:28,flexShrink:0}}>{tarot.emoji}</div>
          <div style={{flex:1}}>
            <div style={{fontSize:17,fontWeight:900,color:"#0A1F1A"}}>{tarot.nome}</div>
            <div style={{fontSize:11,color:"#9CA3AF",marginTop:2}}>{tarot.pal}</div>
          </div>
        </div>
        <div style={{fontSize:14,color:"#374151",lineHeight:1.6,borderLeft:"3px solid #10B981",paddingLeft:12}}>{tarot.msg}</div>
        <div style={{marginTop:8,fontSize:11,color:"#9CA3AF",fontStyle:"italic"}}>Invertido: {tarot.inv}</div>
      </Card>
      ...
      <Card style={{marginBottom:14}}>
        ...
        <div style={{display:"flex",gap:14,alignItems:"center",marginBottom:8}}>
          <div style={{width:54,height:54,borderRadius:14,background:"#0A1F1A",display:"flex",alignItems:"center",justifyContent:"center",fontSize:26,color:"#10B981",fontWeight:900,flexShrink:0}}>{runa.r}</div>
          <div style={{flex:1}}>
            <div style={{fontSize:17,fontWeight:900,color:"#0A1F1A"}}>{runa.n} {runa.e}</div>
            <div style={{fontSize:11,color:"#10B981",fontWeight:700,marginTop:2}}>{runa.sig}</div>
          </div>
        </div>
        <div style={{fontSize:14,color:"#374151",lineHeight:1.6}}>{runa.msg}</div>
      </Card>
      ...
      <Card style={{marginBottom:14}}>
        ...
        <div style={{display:"flex",gap:14,alignItems:"center",marginBottom:8}}>
          <div style={{width:54,height:54,borderRadius:14,background:"#F9FAFB",display:"flex",alignItems:"center",justifyContent:"center",fontSize:28,flexShrink:0}}>{iching.sim}</div>
          <div style={{flex:1}}>
            <div style={{fontSize:17,fontWeight:900,color:"#0A1F1A"}}>{iching.nome}</div>
          </div>
        </div>
        <div style={{fontSize:14,color:"#374151",lineHeight:1.6,borderLeft:"3px solid #10B981",paddingLeft:12}}>{iching.msg}</div>
      </Card>
      ...
      <Card style={{marginBottom:14}}>
        ...
        <div style={{display:"flex",gap:14,alignItems:"center",marginBottom:8}}>
          <div style={{width:54,height:54,borderRadius:14,background:"linear-gradient(135deg,#7C3AED20,#EC489920)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:26,flexShrink:0}}>{anjo.e}</div>
          <div style={{flex:1}}>
            <div style={{fontSize:17,fontWeight:900,color:"#0A1F1A"}}>{anjo.n}</div>
            <div style={{fontSize:11,color:"#7C3AED",fontWeight:700,marginTop:2}}>{anjo.at}</div>
          </div>
        </div>
        <div style={{fontSize:14,color:"#374151",lineHeight:1.6}}>{anjo.msg}</div>
      </Card>

      {/* #23 Qual Deusa Você É */}
      <Card onClick={()=>goTest&&goTest("deusa")} style={{cursor:"pointer",marginBottom:14,borderLeft:"3px solid #EC4899"}}>
        <div style={{display:"flex",gap:12,alignItems:"center"}}>
          <div style={{width:44,height:44,borderRadius:12,background:"#EC489915",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0}}>🌹</div>
          <div style={{flex:1}}>
            <div style={{fontSize:14,fontWeight:800,color:"#0A1F1A"}}>Qual Deusa Mitológica Você É?</div>
            <div style={{fontSize:11,color:"#9CA3AF",marginTop:2}}>Afrodite · Atena · Ártemis · Hera · 8 perguntas</div>
            {profile?.deusa && DEUSA_INFO[profile.deusa] && <div style={{fontSize:10,color:"#EC4899",fontWeight:700,marginTop:4}}>✅ {DEUSA_INFO[profile.deusa].emoji} {DEUSA_INFO[profile.deusa].nome}</div>}
          </div>
          <span style={{fontSize:16,color:"#EC4899",opacity:.6}}>→</span>
        </div>
      </Card>

      {/* #33 Quiz: Adivinhe o signo (inline) */}
      <div style={{marginBottom:14}}>
        <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10}}>🔮 Quizzes Astrais</div>
        {!adivinheActive ? (
          <Card onClick={()=>setAdivinheActive(true)} style={{cursor:"pointer",borderLeft:"3px solid #7C3AED"}}>
            <div style={{display:"flex",gap:12,alignItems:"center"}}>
              <div style={{width:44,height:44,borderRadius:12,background:"#7C3AED15",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0}}>♈</div>
              <div style={{flex:1}}>
                <div style={{fontSize:14,fontWeight:800,color:"#0A1F1A"}}>Adivinhe o Signo</div>
                <div style={{fontSize:11,color:"#9CA3AF",marginTop:2}}>10 rodadas · descrição → acerte o signo</div>
              </div>
              <span style={{fontSize:16,color:"#7C3AED",opacity:.6}}>→</span>
            </div>
          </Card>
        ) : adivinheDone ? (
          <Card style={{textAlign:"center",background:"linear-gradient(135deg,#7C3AED18,#7C3AED06)",border:"1px solid #7C3AED30"}}>
            <div style={{fontSize:36,marginBottom:8}}>🎯</div>
            <div style={{fontSize:22,fontWeight:900,color:"#7C3AED",marginBottom:4}}>{adivinheScore}/10</div>
            <div style={{fontSize:14,color:"#374151",marginBottom:14}}>{adivinheScore>=8?"Astrólogo nato! 🌟":adivinheScore>=5?"Bom olho! 👍":"Continue praticando! 🌱"}</div>
            <button onClick={resetAdivinhe} style={{background:"#7C3AED",color:"#fff",border:"none",borderRadius:20,padding:"8px 20px",fontSize:13,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>Jogar de novo</button>
          </Card>
        ) : (
          <Card style={{border:"1px solid #7C3AED30"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
              <div style={{fontSize:11,color:"#7C3AED",fontWeight:700}}>Rodada {adivinheStep+1}/10</div>
              <div style={{fontSize:11,color:"#9CA3AF"}}>✅ {adivinheScore}</div>
            </div>
            <div style={{height:4,background:"#E5E7EB",borderRadius:3,marginBottom:14,overflow:"hidden"}}>
              <div style={{height:"100%",width:`${((adivinheStep)/10)*100}%`,background:"#7C3AED",borderRadius:3}}/>
            </div>
            <div style={{fontSize:14,fontWeight:600,color:"#0A1F1A",lineHeight:1.6,marginBottom:14,background:"#F9FAFB",borderRadius:10,padding:"12px"}}>{adivinheQ.desc}</div>
            <div style={{display:"flex",flexDirection:"column",gap:8}}>
              {adivinheQ.opts.map((o,i)=>{
                const fb = adivinheFb !== null;
                const isCorrect = i === adivinheQ.c;
                const isPicked = i === adivinhePicked;
                return (
                  <button key={i} onClick={()=>answerAdivinhe(i)} style={{padding:"10px 14px",borderRadius:12,border:`1.5px solid ${fb?(isCorrect?"#10B981":isPicked?"#EF4444":"#E5E7EB"):"#E5E7EB"}`,background:fb?(isCorrect?"#ECFDF5":isPicked?"#FEF2F2":"#fff"):"#fff",color:"#0A1F1A",fontSize:14,fontWeight:500,cursor:"pointer",fontFamily:"inherit",textAlign:"left",transition:"all .15s"}}>{o}</button>
                );
              })}
            </div>
          </Card>
        ...
        {/* #35 e #37 — links para Quizzes */}
        <div style={{display:"flex",gap:8,marginTop:10}}>
          {[
            {key:"mitologia",emoji:"🏛️",nome:"Mitologia dos Signos"},
            {key:"elementos",emoji:"🔥",nome:"Signos e Elementos"},
          ].map(q=>(
            <Card key={q.key} onClick={()=>{ if(goQuizzes) goQuizzes(); }} style={{cursor:"pointer",flex:1,padding:"10px 12px"}}>
              <div style={{fontSize:20,marginBottom:4}}>{q.emoji}</div>
              <div style={{fontSize:12,fontWeight:700,color:"#0A1F1A"}}>{q.nome}</div>
              <div style={{fontSize:10,color:"#10B981",marginTop:3,fontWeight:600}}>Ver no Quizzes →</div>
            </Card>
          ))}
        </div>
      </div>
      ...
      {/* Humor Matinal */}
      {goHumor && (
        <Card onClick={goHumor} style={{cursor:"pointer",marginBottom:14}}>
          <div style={{display:"flex",gap:14,alignItems:"center"}}>
            <div style={{width:44,height:44,borderRadius:12,background:"#3B82F620",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0}}>🌅</div>
            <div style={{flex:1}}>
              <div style={{fontSize:15,fontWeight:800,color:"#0A1F1A"}}>Humor Matinal</div>
              <div style={{fontSize:12,color:"#6B7280",marginTop:2}}>Como você está hoje?</div>
            </div>
...
// Provérbios do dia
const PROVERBIOS_DIA = [
  {p:"Quando você planta bondade, colhe paz.",t:"Provérbio africano",e:"🌱"},
  {p:"O rio não tem como voltar. Siga.",t:"Zen budismo",e:"🌊"},
  {p:"Não é a montanha que cansamos, mas o grão de areia no sapato.",t:"Robert Service",e:"⛰️"},
  {p:"Um homem que não aprende com a história está condenado a repeti-la.",t:"George Santayana",e:"📜"},
  {p:"A árvore que não se dobra quebra com a tempestade.",t:"Provérbio chinês",e:"🎋"},
  {p:"Cuide do seu interior como cuida do exterior.",t:"Confúcio",e:"☯️"},
  {p:"Aquele que conhece os outros é sábio. Aquele que conhece a si mesmo é iluminado.",t:"Lao-Tsé",e:"🌙"},
  {p:"Se você quer ir rápido, vá sozinho. Se quiser ir longe, vá em grupo.",t:"Provérbio africano",e:"🤝"},
  {p:"O início de toda sabedoria é o silêncio.",t:"Pitágoras",e:"🤫"},
  {p:"Não existe vento favorável para quem não sabe onde quer chegar.",t:"Sêneca",e:"⛵"},
  {p:"O coração tem razões que a razão desconhece.",t:"Pascal",e:"❤️"},
  {p:"Conheça todas as teorias. Domine todas as técnicas. Mas ao tocar uma alma humana, seja apenas outra alma humana.",t:"Carl Jung",e:"🪷"},
  {p:"Aquilo que você não tem nome para sentir, sinta assim mesmo.",t:"Adélia Prado",e:"💫"},
  {p:"Faça todo bem que puder. Por todos os meios que puder. Em todos os lugares que puder.",t:"John Wesley",e:"✨"},
  {p:"Seja a mudança que você quer ver no mundo.",t:"Mahatma Gandhi",e:"🕊️"},
  {p:"O sofrimento que não tem palavras é o mais pesado de carregar.",t:"Adélia Prado",e:"🌧️"},
  {p:"O amor não é olhar um ao outro, mas olhar juntos na mesma direção.",t:"Antoine de Saint-Exupéry",e:"👁️"},
  {p:"Uma vida não examinada não vale a pena ser vivida.",t:"Sócrates",e:"🏛️"},
  {p:"Tudo o que somos é resultado do que pensamos.",t:"Buda",e:"☸️"},
  {p:"A maior glória não está em nunca cair, mas em se levantar cada vez que caímos.",t:"Confúcio",e:"🌅"},
  {p:"Prefiro morrer com coragem a viver em covardia.",t:"Crazy Horse",e:"🦅"},
  {p:"O segredo da existência não é viver, mas ter algo pelo que viver.",t:"Dostoiévski",e:"📖"},
  {p:"A gratidão não é apenas a maior das virtudes, mas a mãe de todas as outras.",t:"Cícero",e:"🙏"},
  {p:"Em cada dificuldade existe uma oportunidade.",t:"Einstein",e:"💡"},
  {p:"O medo é inútil. O que é necessário é a fé.",t:"Lucas 8:50",e:"✝️"},
  {p:"Quando perder a paz interior, lembra: nenhuma tempestade dura para sempre.",t:"Rumi",e:"🌬️"},
  {p:"O silêncio não é vazio — é pleno de respostas.",t:"Lao-Tsé",e:"🍃"},
  {p:"Não chore porque acabou. Sorria porque aconteceu.",t:"Gabriel García Márquez",e:"🌸"},
  {p:"O destino embaralha as cartas, mas somos nós que jogamos.",t:"Schopenhauer",e:"🃏"},
  {p:"Você não precisa ver a escada inteira. Dê apenas o primeiro passo.",t:"Martin Luther King Jr.",e:"🪜"},
];
...
function EspiritualidadeScreen({profile, onSaveTradicao, initialTesteAba, goTest}) {
  ...
  return (
    <div>
      ...
      {/* ── TESTES DE ALMA ── */}
      <div style={{fontSize:11,color:"#9CA3AF",fontWeight:700,textTransform:"uppercase",letterSpacing:1,marginBottom:10,marginTop:24}}>
        🧭 Testes de Alma
      </div>
      <div style={{fontSize:12,color:"#6B7280",marginBottom:14}}>Resultados alimentam seu Raio X</div>
      {[
        ...
        {key:"ikigai",     emoji:"☀️", nome:"Seu Ikigai",                        desc:"Artesão · Missionário · Explorador · Profissional",   cor:"#F59E0B"},
      ].map(t=>{
        ...
        return (
          <Card key={t.key} onClick={()=>goTest && goTest(t.key)} style={{cursor:"pointer",borderLeft:`4px solid ${t.cor}`,marginBottom:10}}>
            <div style={{display:"flex",gap:12,alignItems:"center"}}>
...
function TestesScreen({profile, onComplete, goCoincidence, onSaveExtra, initialAba, autoStart, goAstral, goEspiritualidadeTeste, soTestes, soQuizzes}) {
  ...
  const answerQuiz = (idx) => {
    ...
    const finalScore = ok ? qScore + 1 : qScore;
  ...
  const answerGenQuiz = (idx) => {
    ...
    if (gqMode === "surto" && !ok) {
      setTimeout(() => { setGqFb(null); setGqPicked(null); setGqDone(true); }, 1100);
      return;
    }
  ...
  if (aba==="menu") {
    ...
    const novosCards = [
      ...
      {key:"lider", emoji:"👑", nome:"Qual Líder Histórico Você Seria", desc:"12 perguntas · seu estilo de liderança", cor:"#8B5CF6"},
      {key:"financeiro", emoji:"💰", nome:"Seu Perfil Financeiro", desc:"12 perguntas · sua relação com o dinheiro", cor:"#10B981"},
      {key:"elemento", emoji:"🌪️", nome:"Qual Elemento Você É", desc:"12 perguntas · fogo, terra, ar ou água", cor:"#38BDF8"},
      {key:"profissao", emoji:"💼", nome:"Profissão dos Sonhos", desc:"12 perguntas · sua área-vocação", cor:"#F59E0B"},
      {key:"sonhador",  emoji:"🌙", nome:"Tipo de Sonhador",     desc:"12 perguntas · como sua mente cria enquanto dorme", cor:"#7C3AED"},
    ];
    ...
    return (
      <div>
        ...
        {/* ── SEÇÃO QUIZZES (oculto quando soTestes) ── */}
        {!soTestes && (<>
        ...
        <Card onClick={()=>setAba("quiz")} style={{cursor:"pointer"}}>
          <div style={{display:"flex",gap:14,alignItems:"center"}}>
            ...
            <div style={{flex:1}}>
              ...
              <div style={{fontSize:12,color:"#9CA3AF",marginTop:3,marginBottom:6}}>3 níveis · {QUIZ_QUESTIONS.length} perguntas</div>
              <div style={{display:"flex",gap:5}}>
                {[{id:"facil",emoji:"🟢",nome:"Fácil"},{id:"medio",emoji:"🟡",nome:"Médio"},{id:"dificil",emoji:"🔴",nome:"Difícil"}].map(lv=>{
                  const best = profile?.[`qf_${lv.id}`];
                  const total = getQuizByLevel(lv.id).length;
                  return (
                    <span key={lv.id} style={{fontSize:9,fontWeight:700,color:best!=null?"#fff":"#9CA3AF",background:best!=null?"#F59E0B":"#F3F4F6",borderRadius:20,padding:"2px 8px"}}>
                      {lv.emoji} {best!=null?`${best}/${total}`:"—"}
                    </span>
                  );
                })}
              </div>
          ...
          <div style={{display:"flex",gap:14,alignItems:"center"}}>
            ...
            <div style={{flex:1}}>
              ...
              <div style={{display:"flex",gap:5,marginTop:5,flexWrap:"wrap"}}>
                {["⏱️","💀","🎓","🎯"].map(e=><span key={e} style={{fontSize:9,fontWeight:700,color:"#9CA3AF",background:"#F3F4F6",borderRadius:20,padding:"2px 7px"}}>{e}</span>)}
              </div>
            </div>
            <span style={{fontSize:18,color:"#F59E0B",opacity:.6}}>→</span>
          </div>
        </Card>
        {Object.entries(QUIZ_BANKS).map(([key,qb])=>{
          const totalQ = qb.niveis.facil.length + qb.niveis.medio.length + qb.niveis.dificil.length;
          return (
            <Card key={key} onClick={()=>openGenQuiz(key)} style={{cursor:"pointer",borderLeft:`4px solid ${qb.cor}`}}>
              <div style={{display:"flex",gap:14,alignItems:"center"}}>
                <div style={{width:52,height:52,borderRadius:16,background:`${qb.cor}18`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:26}}>{qb.emoji}</div>
                <div style={{flex:1}}>
                  <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:2}}>
                    <div style={{fontSize:15,fontWeight:800,color:"#0A1F1A"}}>{qb.nome}</div>
                    <span style={{fontSize:9,background:qb.cor,color:"#fff",padding:"2px 7px",borderRadius:20,fontWeight:700,flexShrink:0}}>NOVO</span>
                  </div>
                  <div style={{fontSize:12,color:"#9CA3AF"}}>3 níveis · {totalQ} perguntas</div>
                  <div style={{display:"flex",gap:5,marginTop:5,flexWrap:"wrap"}}>
                    {QUIZ_NIVEIS.map(n=>{
                      const score = profile?.[`qb_${key}_${n.id}`];
                      return (
                        <span key={n.id} style={{fontSize:9,fontWeight:700,color:score!=null?n.cor:"#9CA3AF",background:score!=null?`${n.cor}15`:"#F3F4F6",borderRadius:20,padding:"2px 7px"}}>
                ...
                <span style={{fontSize:18,color:qb.cor,opacity:.6}}>→</span>
              </div>
            </Card>
          );
        })}
        ...
        <div>
          ...
          <div style={{position:"relative"}}>
            ...
            <Card style={{textAlign:"center",background:`${qb.cor}12`,border:`1px solid ${qb.cor}30`,position:"relative",overflow:"hidden"}}>
              ...
              {novoRecorde && <div style={{display:"inline-block",fontSize:12,fontWeight:800,color:"#fff",background:qb.cor,borderRadius:20,padding:"5px 14px",animation:"ktBadgePop .5s .25s both"}}>🏆 Novo recorde!</div>}
            </Card>
          </div>
          {wrongPool.length > 0 && (
    ...
    return (
      <div>
        ...
        <div key={gqIdx} style={{animation:"ktSlideIn .35s ease"}}>
          ...
          {gqFb!==null&&<div style={{marginTop:14,padding:"13px 16px",borderRadius:14,background:gqFb?"#ECFDF5":"#FEF2F2",border:`1.5px solid ${gqFb?"#10B981":"#FCA5A5"}`,fontSize:14,color:gqFb?"#065F46":"#991B1B",fontWeight:700,textAlign:"center",animation:"ktPop .4s"}}>{gqFb?"🎉 Acertou em cheio!":`😅 Era: ${q.opts[q.c]}`}</div>}
        </div>
      </div>
    );
  }
...
function PerfilScreen({profile, onSave, onReset, onBack}) {
  ...
  const TODOS_CAMPOS = ["temperamento","amor","politico","personalidade","profissional","lider","financeiro","elemento","profissao","sonhador","tradicao","filosofo","visaomundo","espvrel","corrente","virtude","ikigai","deusa"];
      ...
      <div>
        ...
        <Card style={{marginBottom:14}}>
          ...
          {[
            ...
            {l:"Líder Histórico",v:LIDER_LABELS[profile?.lider],cor:"#8B5CF6"},
            {l:"Perfil Financeiro",v:FIN_LABELS[profile?.financeiro],cor:"#F59E0B"},
            {l:"Elemento",v:ELEM_LABELS[profile?.elemento],cor:"#06B6D4"},
            {l:"Profissão dos Sonhos",v:PROF2_LABELS[profile?.profissao],cor:"#10B981"},
            {l:"Tipo de Sonhador",v:SONHADOR_LABELS[profile?.sonhador],cor:"#7C3AED"},
            {l:"Filósofo",v:FILOSOFO_LABELS[profile?.filosofo],cor:"#1E40AF"},
            {l:"Visão de Mundo",v:VISAO_LABELS[profile?.visaomundo],cor:"#8B5CF6"},
            {l:"Espiritualidade",v:ESPVREL_LABELS[profile?.espvrel],cor:"#10B981"},
            {l:"Corrente Filosófica",v:CORRENTE_LABELS[profile?.corrente],cor:"#374151"},
            {l:"Virtude Pilar",v:VIRTUDE_LABELS[profile?.virtude],cor:"#DC2626"},
            {l:"Ikigai",v:IKIGAI_LABELS[profile?.ikigai],cor:"#F59E0B"},
            {l:"Deusa Mitológica",v:DEUSA_LABELS[profile?.deusa],cor:"#EC4899"},
  ...
  return (
    <div style={{minHeight:"100vh",background:"#F8FAFB",fontFamily:"'Sora',sans-serif",paddingBottom:90}}>
      ...
      <div style={{position:"fixed",bottom:0,left:0,right:0,background:"#fff",borderTop:"1px solid #F0F0F0",display:"flex",justifyContent:"space-around",alignItems:"center",padding:"8px 0 20px",boxShadow:"0 -4px 20px #0000000a",zIndex:100}}>
        {NAV.map(n=>{
          const isActive = tab===n.id||(tab==="coincidencia"&&n.id==="komparai")||(tab==="perfil"&&n.id==="komparai");
          return (
