...
const QUIZ_BANKS = {
  ...
  bandeiras: {
    emoji: "🚩", nome: "Bandeiras do Mundo", cor: "#EF4444", desc: "Reconheça a bandeira do país",
    niveis: {
      facil: [
        { q: "De que país é esta bandeira?", flag:"🇨🇦", opts: ["EUA","Canadá","Austrália","Nova Zelândia"], c: 1 },
        { q: "De que país é esta bandeira?", flag:"🇯🇵", opts: ["China","Coreia do Sul","Japão","Vietnã"], c: 2 },
        { q: "De que país é esta bandeira?", flag:"🇧🇷", opts: ["Brasil","Camarões","Gana","Jamaica"], c: 0 },
        { q: "De que país é esta bandeira?", flag:"🇺🇸", opts: ["Reino Unido","Austrália","EUA","Libéria"], c: 2 },
        { q: "De que país é esta bandeira?", flag:"🇫🇷", opts: ["Itália","Rússia","França","Holanda"], c: 2 },
      ],
      medio: [
        { q: "De que país é esta bandeira?", flag:"🇬🇧", opts: ["Dinamarca","Austrália","Suíça","Reino Unido"], c: 3 },
        { q: "De que país é esta bandeira?", flag:"🇦🇷", opts: ["Uruguai","Argentina","Grécia","Israel"], c: 1 },
        { q: "De que país é esta bandeira?", flag:"🇨🇳", opts: ["Vietnã","Cuba","China","Turquia"], c: 2 },
        { q: "De que país é esta bandeira?", flag:"🇸🇪", opts: ["Finlândia","Noruega","Suécia","Islândia"], c: 2 },
        { q: "De que país é esta bandeira?", flag:"🇩🇪", opts: ["Bélgica","Alemanha","Espanha","Angola"], c: 1 },
      ],
      dificil: [
        { q: "De que país é esta bandeira?", flag:"🇧🇹", opts: ["Butão","Nepal","Sri Lanka","Mongólia"], c: 0 },
        { q: "De que país é esta bandeira?", flag:"🇱🇧", opts: ["Líbano","Chipre","Canadá","Eritreia"], c: 0 },
        { q: "De que país é esta bandeira?", flag:"🇳🇵", opts: ["Suíça","Nepal","Vaticano","Catar"], c: 1 },
        { q: "De que país é esta bandeira?", flag:"🇲🇿", opts: ["Angola","Moçambique","Zimbábue","Congo"], c: 1 },
        { q: "De que país é esta bandeira?", flag:"🇲🇽", opts: ["Egito","México","Albânia","Equador"], c: 1 },
      ],
    },
  },
  capitais: {
...
function PerfilScreen({profile, onSave, onReset, onBack}) {
  ...
  const TODOS_CAMPOS = ["temperamento","amor","politico","personalidade","profissional","lider","financeiro","elemento","profissao","tradicao"];
  ...
  return (
    <div style={{minHeight:"100vh",background:"#F8FAFB",fontFamily:"'Sora',sans-serif",paddingBottom:90}}>
      ...
      <div style={{maxWidth:440,margin:"0 auto",padding:"20px 16px 0",animation:"fadeUp .35s"}}>
        ...
        {tab==="hoje" && <HomeScreen profile={profile} goCoincidence={()=>setTab("komparai")} goTest={()=>setTab("testes")} goEspiritualidade={()=>setTab("espiritualidade")}/>}
