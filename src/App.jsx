...
const CountUp = ({end=0, duration=1100, style}) => {
...
function ScannerScreen({name}) {
  ...
  useEffect(() => {
    const id = setInterval(() => setLine(l => (l+1) % SCAN_LINES.length), 260);
      ...
      <div style={{background:"linear-gradient(160deg,#10B981,#047857)",borderRadius:24,padding:"24px 20px",marginBottom:14,position:"relative",overflow:"hidden"}}>
        ...
        <div style={{position:"relative",zIndex:2}}>
          ...
          <div style={{display:"flex",alignItems:"baseline",gap:10}}>
            <div style={{fontSize:64,fontWeight:900,color:"#fff",lineHeight:1,letterSpacing:-4}}><CountUp end={total} duration={1100}/></div>
