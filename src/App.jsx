...
// ============================================================
function TestesScreen({profile, onComplete, goCoincidence, onSaveExtra, initialAba, goAstral, goEspiritualidadeTeste}) {
...
export default function App() {
  ...
  useEffect(()=>{
    ...
    if (tab !== "testes") setTestesInitialAba(null);
  }, [tab]);
  ...
  return (
    <div style={{minHeight:"100vh",background:"#F8FAFB",fontFamily:"'Sora',sans-serif",paddingBottom:90}}>
      ...
      <div style={{maxWidth:440,margin:"0 auto",padding:"20px 16px 0",animation:"fadeUp .35s"}}>
        ...
        {tab==="testes" && <TestesScreen profile={profile} onComplete={onTestDone} goCoincidence={()=>setTab("komparai")} onSaveExtra={saveToProfile} initialAba={testesInitialAba} goAstral={testesInitialAba==="humor" ? ()=>{setTestesInitialAba(null); setTab("astral");} : null} goEspiritualidadeTeste={()=>{setEspiritualidadeInitialAba("perguntas"); setTab("espiritualidade");}}/>}
